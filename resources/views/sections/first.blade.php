<section class="first-page" id="products">
    <h1>Top Products</h1>
    <div class="container-card">
        <div class="card">
            <img src="{{ asset('img/products/prolez-1.jpg') }}">
            <div class="desc">
                <h2>Ayam Tulang Lunak</h2>
                <p>Ayam tulang lunak Lezazel merupakan salah satu produk makanan beku terbaik, .</p>
                <button
        ...
        <div class="card">
            <img src="{{ asset('img/products/prolez-2.jpg') }}">
            <div class="desc">
