...
<head>
    ...
    <title>Login &mdash; Lezazel</title>
        ...
        <section class="section">
            <div class="d-flex align-items-stretch flex-wrap">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="m-3 p-4">
                        <img src="{{ asset('img/lezazel_logo.svg') }}" alt="logo" width="80"
                            class="shadow-light rounded-circle mb-5 mt-2">
                        <h4 class="text-dark font-weight-normal">Welcome to <span
                                class="font-weight-bold">Lezazel</span>
                        </h4>
                        ...
                        <div class="text-small mt-5 text-center">
                            Copyright &copy; Lezazel Food. Made with 💙 by Lezazel Developer
                            <div class="mt-2">
                ...
                <div class="col-lg-8 col-12 order-lg-2 min-vh-100 background-walk-y position-relative overlay-gradient-bottom order-1"
                    data-background="{{ asset('img/unsplash/login.jpg') }}">
